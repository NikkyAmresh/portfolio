      ...
      <div className="skills_content">
        ...
        <div className="skills_main">
          <div className="left_side">
            ...
            <span className="tag_h1">&lt;h1/&gt;</span> <br />
            <TextSplit splitBy="words" className="left_side_text">
              Main area of my expertise is front end development and everything
              related with this side of web. HTML, CSS, JS(ES5,ES6), building
              Web Apps, ReactJS, building features, animations and just coding
              layouts.
            </TextSplit>
            <TextSplit className="left_side_text" splitBy="words">
              I have also some experience with Angular, Django, Node.js.
            </TextSplit>
            <TextSplit className="left_side_text" splitBy="words">
            ...
            <p className="left_side_text">
              ...
              <TextSplit
                tagName="link"
                splitBy="words"
                to="https://www.linkedin.com/in/Nikky Amresh/"
                target="_blank"
                className="left_side_link"
              >
                LinkedIn
              </TextSplit>
