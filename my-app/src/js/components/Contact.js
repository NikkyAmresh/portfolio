...
let defaultProps = {
  /*GOOGLE MAPS PROPS*/
  center: { lat: 25.5940947, lng: 85.1375645 },
  zoom: 13,
  mapStyles: [
    {
      featureType: "all",
...
const StyledMapWithAnInfoBox = compose(
  withProps({
    googleMapURL:
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyBa7trDSsEedbuHDCqBFTLtJIAtSHYrg9s&v=3.exp&libraries=geometry,drawing,places",
